...
import { IUserInstance } from '../../../src/models/MUser';
import { JWT_SECRET } from '../../../src/utils/utils';
import { IPostInstance } from '../../../src/models/MPost';
import { ICommnetInstance } from '../../../src/models/MComment';
...
describe('Comment', () => {
    ...
    beforeEach(() => {
        return db.Comment.destroy({where: {}})
            ...
            }).then((comments: ICommnetInstance[]) => {
